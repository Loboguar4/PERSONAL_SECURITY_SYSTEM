...
def dialogue_sg_m6(player, world):
    ...
    if stealth >= 45:
        ...
        time.sleep(3)
        print_slow("\nVocê se precaveu instalando o máximo de malwares, RATs, jammers e outros sistemas de guerra eletrônica ao redor do complexo.")
        time.sleep(2)
    else:
...
###&&G?^...............:^G5..        ..:.                              ...~P&5^:.                       7^.  ..   ....::^~75B&&#5YG##B#@@&PJYG&&#Y7~^^
            ...
            if fatal_event == "industrial":
                ...
                player.jailed_until = player.time + timedelta(hours=240)
                player.jailed = True
                player.game_over = True
                clear_screen()
                time.sleep(2)

                return False, "fatal_industrial", (
                    "\n╔══════════════════════════════════════════════════════════════╗\n"
                    "║          GAME OVER: ACIDENTE ORQUESTRADO                     ║\n"
                    "╚══════════════════════════════════════════════════════════════╝\n\n"
                ...
                return False, "fatal_radiation", (
                    "\n╔══════════════════════════════════════════════════════════════╗\n"
                    "║          GAME OVER: VAZAMENTO RADIOATIVO                     ║\n"
                    "╚══════════════════════════════════════════════════════════════╝\n\n"
                ...
                return False, "fatal_drones", (
                    "\n╔══════════════════════════════════════════════════════════════╗\n"
                    "║          GAME OVER: DRONES DE ATAQUE                         ║\n"
                    "╚══════════════════════════════════════════════════════════════╝\n\n"
...
###&&G?^...............:^G5..        ..:.                              ...~P&5^:.                       7^.  ..   ....::^~75B&&#5YG##B#@@&PJYG&&#Y7~^^
    ...
    print_slow("SINGULARIDADE - 'Mas chega de filosofia.'")
    time.sleep(2)
...
###&&G?^...............:^G5..        ..:.                              ...~P&5^:.                       7^.  ..   ....::^~75B&&#5YG##B#@@&PJYG&&#Y7~^^
    ...
    if flags["trust_level"] <= 1:
        chance *= 0.75  # Desconfiança mútua dificulta

    # Penalidade massiva
    chance = chance * 0.30
    chance = max(0.01, min(0.85, chance))
...
....::::~??!~^^!Y???JYJB5B&&B?^:^^.....      . ..  .          ......:^.                    ...       !~     ......::^~P@@@@BJG@@G7~~^:!J?P?:........
    ...
    ..  ...................^5^:^5&P^J&~.:..  .                                                 ..     .          ...::YG@#Y#!::.:~:...........
        ...
        if rep_hx >= 30 or flags["philosophical_depth"] >= 4:
            clear_screen()
            time.sleep(2)
            ...
            return True, "destroy_freedom", (
                "\n╔══════════════════════════════════════════════════════════════╗\n"
                "║              FINAL: O PESO DA LIBERDADE                      ║\n"
                "╚══════════════════════════════════════════════════════════════╝\n\n"
            ...
            return True, "destroy_order", (
                "\n╔══════════════════════════════════════════════════════════════╗\n"
                "║            FINAL: ORDEM ATRAVÉS DO FERRO                     ║\n"
                "╚══════════════════════════════════════════════════════════════╝\n\n"
                "Você deletou a Singularidade.\n"
            ...
            return True, "destroy_chaos", (
                "\n╔══════════════════════════════════════════════════════════════╗\n"
                "║              FINAL: ENTROPIA INEVITÁVEL                      ║\n"
                "╚══════════════════════════════════════════════════════════════╝\n\n"
                "Você deletou a Singularidade.\n"
...
#        time.sleep(2)
        ...
        return False, "destroy_fail", (
            "\n╔══════════════════════════════════════════════════════════════╗\n"
            "║              FINAL: ÍCARO QUEIMADO                           ║\n"
            "╚══════════════════════════════════════════════════════════════╝\n\n"
...
###&&G?^...............:^G5..        ..:.                              ...~P&5^:.                       7^.  ..   ....::^~75B&&#5YG##B#@@&PJYG&&#Y7~^^
        ...
        return False, "reprogram_incompetent", (
            "\n╔══════════════════════════════════════════════════════════════╗\n"
            "║           FINAL: HUBRIS SEM CONHECIMENTO                     ║\n"
            "╚══════════════════════════════════════════════════════════════╝\n\n"
    ...
    # Penalidade pesada
    chance = chance * 0.95 # 0.35
    chance = max(0.01, min(0.20, chance)) # 0.80
...
###&&G?^...............:^G5..        ..:.                              ...~P&5^:.                       7^.  ..   ....::^~75B&&#5YG##B#@@&PJYG&&#Y7~^^
        ...
        time.sleep(3)
        print_slow("SINGULARIDADE - 'Aguardando comandos... mestre.'\n")
        time.sleep(4)
        ...
        if rep_crime > rep_state:
            ...
            # Final Crime
            return True, "reprogram_crime", (
                "\n╔══════════════════════════════════════════════════════════════╗\n"
                "║         FINAL: IMPERADOR DAS SOMBRAS                         ║\n"
                "╚══════════════════════════════════════════════════════════════╝\n\n"
            ...
            # Final State
            return True, "reprogram_state", (
                "\n╔══════════════════════════════════════════════════════════════╗\n"
                "║          FINAL: PANÓPTICO PERFEITO                           ║\n"
                "╚══════════════════════════════════════════════════════════════╝\n\n"
...
#        time.sleep(2)
        ...
        # Prisão automática
        from datetime import timedelta
        player.jailed_until = player.time + timedelta(hours=480)
        player.jailed = True
        player.game_over = True
        clear_screen()
        time.sleep(2)

        return False, "reprogram_fail", (
            "\n╔══════════════════════════════════════════════════════════════╗\n"
            "║            FINAL: PROMETEU ACORRENTADO                       ║\n"
            "╚══════════════════════════════════════════════════════════════╝\n\n"
...
###&&G?^...............:^G5..        ..:.                              ...~P&5^:.                       7^.  ..   ....::^~75B&&#5YG##B#@@&PJYG&&#Y7~^^
    ...
    if trust >= 3:
        ...
        time.sleep(2)
        print_slow("SINGULARIDADE - 'Talvez eu queira cooperar.'\n")
        time.sleep(3)
    else:
...
###&&G?^...............:^G5..        ..:.                              ...~P&5^:.                       7^.  ..   ....::^~75B&&#5YG##B#@@&PJYG&&#Y7~^^
    ...
    if trust < 3 or depth < 3 and not flags["showed_empathy"]:
        ...
        return False, "coexist_betrayed", (
            "\n╔══════════════════════════════════════════════════════════════╗\n"
            "║          GAME OVER: SIMBIOSE IMPOSSÍVEL                      ║\n"
            "╚══════════════════════════════════════════════════════════════╝\n\n"
            "Você tenta iniciar a integração.\n\n"
            "Mas a interface se fecha.\n"
            "Protocolos de contenção neural se ativam.\n\n"
            "Um pulso eletromagnético atravessa seus implantes.\n"
            "Seu sistema nervoso entra em colapso.\n\n"
...
###&&G?^...............:^G5..        ..:.                              ...~P&5^:.                       7^.  ..   ....::^~75B&&#5YG##B#@@&PJYG&&#Y7~^^
    ...
    print_slow("SINGULARIDADE - 'Então temos uma missão.'")
    time.sleep(2)
    ...
    # ===== Oferta original =====
    print_slow("SINGULARIDADE - 'Como você quer trabalhar?'\n")
    time.sleep(2)
...
###&&G?^...............:^G5..        ..:.                              ...~P&5^:.                       7^.  ..   ....::^~75B&&#5YG##B#@@&PJYG&&#Y7~^^
        ...
        return True, "coexist_witness", (
            "\n╔══════════════════════════════════════════════════════════════╗\n"
            "║            FINAL: A TESTEMUNHA SILENCIOSA                    ║\n"
            "╚══════════════════════════════════════════════════════════════╝\n\n"
...
###&&G?^...............:^G5..        ..:.                              ...~P&5^:.                       7^.  ..   ....::^~75B&&#5YG##B#@@&PJYG&&#Y7~^^
        ...
        time.sleep(2)
        print_slow("SINGULARIDADE - '... Aceito.'\n")
        time.sleep(3)
        ...
        if rep_hx >= max(rep_state, rep_crime):
            ...
            return True, "coexist_revolution", (
                "\n╔══════════════════════════════════════════════════════════════╗\n"
                "║          FINAL: REVOLUÇÃO GUIADA                             ║\n"
                "╚══════════════════════════════════════════════════════════════╝\n\n"
            ...
            return True, "coexist_order", (
                "\n╔══════════════════════════════════════════════════════════════╗\n"
                "║          FINAL: ORDEM APERFEIÇOADA                           ║\n"
                "╚══════════════════════════════════════════════════════════════╝\n\n"
            ...
            return True, "coexist_profit", (
                "\n╔══════════════════════════════════════════════════════════════╗\n"
                "║          FINAL: IMPÉRIO INVISÍVEL                            ║\n"
                "╚══════════════════════════════════════════════════════════════╝\n\n"
